...
if __name__ == '__main__':
    Mu1 = np.array([0.42857143, 0.42857143, 0.14285714])
    Mu2 = np.array([0.36, 0.36, 0.28])
    Mu3 = np.array([0.36850817, 0.36050594, 0.27098589])
    Mu4 = np.array([0.25826115, 0.25612681, 0.48561204])
    SLSQP(Mu1, Mu2, Mu3, Mu4)
